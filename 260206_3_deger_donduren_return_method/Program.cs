namespace _260206_3_deger_donduren_return_method
{
    internal class Program
    {
        ...
        static int Topla(int sayi1,int sayi2)//isimden önce int var,değer döndüren
        {
            ...
            return toplam;//int ile belirtilen method retunrn ile min int(daha küçük değer aralığına sahip veri tipleri de yazılabilir) değer alan değişken,sayı verilmelidir.returen ile beraber method sonlanır, bundan dolayı return un yazıldığı yer çook önemlidir
        }
