namespace _260130_1_Diziler
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            numbers[0] = 0;//index numbers[0] şeklinde tanımlanır ama 1. eleman olarak ifade edilir diziye eleman atamak için kullanılan yoldur
            ...
            Console.WriteLine("Dizinin 1.indexi yani 2.elemanı:" + numbers[1]);
            Console.WriteLine("Dizinin 2.indexi yani 3.elemanı:" + numbers[2]);
            Console.WriteLine("Dizinin 3.indexi yani 4.elemanı:" + numbers[3]);
            ...
            {
                Console.WriteLine("Dizinin"+i+"indexin yani" + (i + 1) + ".elemanı:" + numbers[i]);
            }
            ...
            //dizisi eleman sayısı 6 ama ben 7 elemanı eklersem ne olur??
            //islem[6] = 301;//index was outside...şeklinde hata verir, buda dizinin eleman sayısı aşıldı, eklenemez anlamına geliyor
