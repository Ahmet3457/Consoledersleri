    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("10 değeri ++ ile artırıldı:" + deger1);
            ...
            //int deger3 = deger2++ + 10;//ilkin deger2 değeri deger3 e eşitlenir sonra ++ işlemi deger2ye uygulanır
            int deger3 = deger2 = ++deger2 + 10;//deger2 nin değeri 1 artırılır ve 10 ile toplanarak deger3e atanır. değer artımı yapılarak eşitleme yapılır
            ...
            Console.WriteLine("Mod Alama:" +s1%s2);
            Console.WriteLine("------------------------");
